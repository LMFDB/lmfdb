...
class WebG2C(object):
    ...
    def make_object(self, curve, endo, tama, ratpts, clus, is_curve):
        ...
        if is_curve:
            ...
            data['aut_grp'] = abstract_group_display_knowl('%d.%d' % tuple(literal_eval(curve['aut_grp_id'])))
            data['geom_aut_grp'] = abstract_group_display_knowl('%d.%d' % tuple(literal_eval(curve['geom_aut_grp_id'])))
