...
class Genus2Test(LmfdbTest):
    ...
    def test_download(self):
        L = self.tc.get("/Genus2Curve/Q/?query={'abs_disc':3976}&download=1&submit=gp")
        L = self.tc.get("/Genus2Curve/Q/?query={'abs_disc':3976}&download=1&submit=sage")
        L = self.tc.get("/Genus2Curve/Q/?query={'abs_disc':3976}&download=1&submit=magma")
