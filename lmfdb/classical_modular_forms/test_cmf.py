...
class CmfTest(LmfdbTest):
    ...
    def test_expression_divides(self):
        ...
        self.check_args(
            '/ModularForm/GL2/Q/holomorphic/?level_type=divides&level=1000',
            '40.2.k.a')
    ...
    def test_stats(self):
        ...
        assert "Classical modular forms: Statistics" in page.get_data(
            as_text=True)
    ...
    def test_dynamic_stats(self):
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/dynamic_stats?char_order=2&col1=level&buckets1=1-1000%2C1001-10000&proportions=recurse&col2=weight&buckets2=1-8%2C9-316&search_type=DynStats")
    ...
    def test_sidebar(self):
        data = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/Labels").get_data(as_text=True)
        assert 'Labels for classical modular forms' in data
        data = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/Completeness").get_data(as_text=True)
        assert "Completeness of classical modular form data" in data
        data = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/Reliability").get_data(as_text=True)
        assert "Reliability of classical modular form data" in data
        data = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/Source").get_data(as_text=True)
        assert "Source of classical modular form data" in data

    def test_badp(self):
        data = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?level_primes=7&count=100").get_data(as_text=True)
    ...
    def test_level_bread(self):
        ...
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/1124/?weight=10&level=10',
            follow_redirects=True)
        ...
        for Nk2 in range(1, 2001):
            for N in ZZ(Nk2).divisors():
                ...
                if k in ZZ and k > 1:
                    ...
                    url = "/ModularForm/GL2/Q/holomorphic/{0}/{1}/".format(
                        N, k)
                    rv = self.tc.get(url, follow_redirects=True)
                    self.assertTrue(
                        rv.status_code == 200,
                        "Request failed for {0}".format(url))
    ...
    def test_favorite(self):
        ...
        for l in favorite_newform_labels:
            for elt, desc in l:
                page = self.tc.get(
                    "/ModularForm/GL2/Q/holomorphic/?jump=%s" %
                    elt, follow_redirects=True)
                assert (
                    "Newform orbit %s" %
                    elt) in page.get_data(
                    as_text=True)
                # redirect to the same page
                page = self.tc.get(
                    "/ModularForm/GL2/Q/holomorphic/%s" %
                    elt, follow_redirects=True)
                assert (
                    "Newform orbit %s" %
                    elt) in page.get_data(
        ...
        for l in favorite_space_labels:
            for elt, desc in l:
                ...
                # redirect to the same page
                assert "Space of modular forms of " in page.get_data(
                    as_text=True)
                page = self.tc.get(
                    "/ModularForm/GL2/Q/holomorphic/%s" %
                    elt, follow_redirects=True)
    ...
    def test_tracehash(self):
        for t, l in [[1329751273693490116, '7.3.b.a'], [
                1294334189658968734, '4.5.b.a'], [0, 'not found']]:
            page = self.tc.get(
                "/ModularForm/GL2/Q/holomorphic/?jump=%%23%d" %
                t, follow_redirects=True)
            assert l in page.get_data(as_text=True)

    def test_jump(self):
        for j, l in [['10', '10.3.c.a'], ['3.6.1.a', '3.6.a.a'], ['55.3.d', '55.3.d'], ['55.3.54', '55.3.d'], ['20.5', '20.5'], [
                'yes', '23.1.b.a'], ['yes&weight=2', '11.2.a.a'], ['yes&weight=-2', 'There are no newforms specified by the query']]:
            page = self.tc.get(
                "/ModularForm/GL2/Q/holomorphic/?jump=%s" %
    ...
    def test_failure(self):
        ...
        """
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/983/2000/c/a/',
            follow_redirects=True)
        ...
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/1000/4000/a/a/',
            follow_redirects=True)
        assert "Level and weight too large" in page.get_data(as_text=True)
        assert " for trivial character." in page.get_data(as_text=True)
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/100/2/z/a/',
            follow_redirects=True)
        assert "The newform 100.2.z.a is not in the database" in page.get_data(
            as_text=True)
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/?level=1000&weight=100-',
            follow_redirects=True)
        assert "No matches" in page.get_data(as_text=True)
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/maria/',
            follow_redirects=True)
        assert 'maria' in page.get_data(
            as_text=True) and "is not a valid newform" in page.get_data(
            as_text=True)
    ...
    def test_delta(self):
        ...
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/1/12/a/a/?format=satake")
    ...
    def test_level11(self):
        ...
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/11/2/a/a/?format=satake")
        ...
        page = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/11/2/a/a/',
            follow_redirects=True)
    ...
    def test_get_args(self):
        ...
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/13/10/1/",
            follow_redirects=True)
        assert '11241' in page.get_data(as_text=True)
        assert '10099' in page.get_data(as_text=True)
    ...
    def test_empty(self):
        ...
        assert 'The following table gives the dimensions of various' in page.get_data(
            as_text=True)
        ...
        assert 'weight is odd while the character is ' in page.get_data(
            as_text=True)
        page = self.tc.get("/ModularForm/GL2/Q/holomorphic/12/6/a/")
        for elt in ['Decomposition',
                    r'S_{6}^{\mathrm{old}}(\Gamma_0(12))', 'lower level spaces']:
            assert elt in page.get_data(as_text=True)
    ...
    def test_character_validation(self):
        ...
        assert 'since the weight is even while the character is' in page.get_data(
            as_text=True)

    def test_decomposition(self):
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/6/12/",
            follow_redirects=True)
        assert r'Decomposition</a> of \(S_{12}^{\mathrm{new}}(\Gamma_1(6))\)' in page.get_data(
            as_text=True)
        ...
        for elt in ['Decomposition',
                    r"S_{9}^{\mathrm{old}}(\Gamma_1(38))", "lower level spaces"]:
            assert elt in page.get_data(as_text=True)
        decomposition = r"""
<div class="center">
...
"""
    ...
    def test_convert_conreylabels(self):
        for c in [27, 31]:
            page = self.tc.get(
                '/ModularForm/GL2/Q/holomorphic/38/9/%d/a/' %
                c, follow_redirects=True)
            assert "Newform orbit 38.9.d.a" in page.get_data(as_text=True)
            for e in range(1, 13):
                page = self.tc.get(
                    '/ModularForm/GL2/Q/holomorphic/38/9/d/a/%d/%d/' %
                    (c, e), follow_redirects=True)
                assert "Newform orbit 38.9.d.a" in page.get_data(as_text=True)

    def test_maximal(self):
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?level=1234&weight=2")
        ...
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?level=1234&weight=2&is_maximal_largest=maximal")
        ...
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?level=1234&weight=2&is_maximal_largest=largest")
        assert '5 matches' in page.get_data(as_text=True)
        assert '1234.2.a.h' in page.get_data(as_text=True)
        assert '1234.2.a.i' in page.get_data(as_text=True)
        assert '1234.2.b.c' not in page.get_data(as_text=True)
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?level=1234&weight=2&is_maximal_largest=notlargest")
    ...
    def test_dim_table(self):
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?weight=12&level=23&search_type=Dimensions",
            follow_redirects=True)
        assert 'Dimension search results' in page.get_data(as_text=True)
        assert '229' in page.get_data(as_text=True)  # Level 23, Weight 12

        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?weight=12&level=1-100&search_type=Dimensions",
            follow_redirects=True)
        assert 'Dimension search results' in page.get_data(as_text=True)
        assert '229' in page.get_data(as_text=True)  # Level 23, Weight 12

        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?search_type=Dimensions",
            follow_redirects=True)
        assert 'Dimension search results' in page.get_data(as_text=True)
        ...
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/?level=1-100&weight=1-20&search_type=Dimensions',
            follow_redirects=True)
        ...
        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?level=3900-4100&weight=1-12&char_order=2-&search_type=Dimensions",
            follow_redirects=True)
        assert '426' in page.get_data(as_text=True)  # Level 3999, Weight 1
        assert '128' in page.get_data(as_text=True)  # Level 4000, Weight 1

        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?level=3900-4100&weight=1-12&char_order=1&search_type=Dimensions",
            follow_redirects=True)
        assert 'Dimension search results' in page.get_data(as_text=True)
        assert '0' in page.get_data(as_text=True)

        page = self.tc.get(
            "/ModularForm/GL2/Q/holomorphic/?level=4002&weight=1&char_order=2-&search_type=Dimensions",
            follow_redirects=True)
        assert 'Dimension search results' in page.get_data(as_text=True)
        assert 'n/a' in page.get_data(as_text=True)

        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/?level=7,10&weight_parity=odd&char_parity=odd&count=50&search_type=Dimensions')
        for elt in map(str, [0, 1, 2, 5, 4, 9, 6, 13, 8, 17, 10]):
            assert elt in page.get_data(as_text=True)
        assert 'Dimension search results' in page.get_data(as_text=True)

        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/?weight_parity=odd&level=1-1000&weight=1-100&search_type=Dimensions')
        assert 'Error: Table too large: must have at most 10000 entries' in page.get_data(
            as_text=True)
    ...
    def test_character_parity(self):
        ...
        assert 'since the weight is even while the character is' in page.get_data(
            as_text=True)
        page = self.tc.get("/ModularForm/GL2/Q/holomorphic/12/3/a/")
        assert 'since the weight is odd while the character is' in page.get_data(
            as_text=True)
        ...
        urls_set = [
            ...
            [('/ModularForm/GL2/Q/holomorphic/5/9/c/a/', 'Newform orbit 5.9.c.a'),
             ('/ModularForm/GL2/Q/holomorphic/5/9/c/a/2/3/',
              'Dual form 5.9.c.a.2.3'),
             ('/ModularForm/GL2/Q/holomorphic/5/9/c/a/3/3/',
              'Dual form 5.9.c.a.3.3'),
             ],
            [
                ('/ModularForm/GL2/Q/holomorphic/13/2/e/a/',
                 'Newform orbit 13.2.e.a'),
                ('/ModularForm/GL2/Q/holomorphic/13/2/e/a/4/1/',
                 'Dual form 13.2.e.a.4.1'),
    ...
    def test_embedded_invariants(self):
        for url in ['/ModularForm/GL2/Q/holomorphic/13/2/e/a/4/1/',
            ...
            # p = 47
            for n in ['3.46410', '0.505291',
                      '0.967559', '0.252646', '0.918699']:
                assert n in page.get_data(as_text=True)
    ...
    def test_satake(self):
        ...
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/25/2/e/a/?n=97&m=8&prec=6&format=satake_angle')
        assert '0.0890699' in page.get_data(as_text=True)
        assert '0.689070' in page.get_data(as_text=True)

        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/25/2/d/a/?m=4&n=97&prec=6&format=satake_angle')
        assert '0.237314' in page.get_data(as_text=True)
        assert '0.637314' in page.get_data(as_text=True)

        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/210/2/a/a/?format=satake&n=2-20')
        # alpha_11
        ...
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/99/2/p/a/?n=2-10&m=2.1%2C+95.10&prec=6&format=embed')
        for elt in ['2.1', '95.10', '1.05074',
                    '0.946093', '2.90568', '0.305399']:
            assert elt in page.get_data(as_text=True)

        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/13/2/e/a/?m=1-2&n=2-10000&prec=6&format=embed')
        assert "Only" in page.get_data(as_text=True)
        assert "up to 1000 are available" in page.get_data(as_text=True)
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/7524/2/l/b/?n=5000&m=&prec=&format=embed')
        assert "Only" in page.get_data(as_text=True)
        assert "up to 3000 are available" in page.get_data(as_text=True)
        assert "in specified range; resetting to default" in page.get_data(
            as_text=True)
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/7524/2/l/b/?n=1500-4000&m=&prec=&format=embed')
        assert "Only" in page.get_data(as_text=True)
        assert "up to 3000 are available" in page.get_data(as_text=True)
        assert "limiting to" in page.get_data(as_text=True)

        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/13/2/e/a/?m=1-2&n=3.5&prec=6&format=embed')
        assert "must be an integer, range of integers or comma separated list of integers" in page.get_data(
            as_text=True)
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/419/3/h/a/?n=2-10&m=1-20000&prec=6&format=embed',
            follow_redirects=True)
        assert "Web interface only supports 1000 embeddings at a time.  Use download link to get more (may take some time)." in page.get_data(
            as_text=True)
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/419/3/h/a/?n=3.14&format=embed',
            follow_redirects=True)
        assert "must be an integer, range of integers or comma separated list of integers" in page.get_data(
            as_text=True)
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/99/2/p/a/?n=2-10&m=1-20&prec=16&format=embed')
        assert 'must be a positive integer, at most 15 (for higher precision, use the download button)' in page.get_data(
            as_text=True)
        page = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/99/2/p/a/?n=999-1001&m=1-20&prec=6&format=embed')
        assert 'Only' in page.get_data(as_text=True)
        assert 'up to 1000 are available' in page.get_data(as_text=True)
    ...
    def test_underlying_data(self):
        ...
        data = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/data/13.2.e.a.4.1').get_data(as_text=True)
        assert ('mf_newforms' in data and 'field_disc_factorization' in data and
    ...
    def test_character_values(self):
        ...
        data = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/12/3/c/a/').get_data(as_text=True)
...
"""
        ...
        data = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/119/1/d/a/').get_data(as_text=True)
        character_values_table = r"""
<table class="ntdata">
  <tbody>
        <tr>
...
"""
        ...
        # An embedded newform
        data = self.tc.get(
            '/ModularForm/GL2/Q/holomorphic/119/1/d/a/118/1/').get_data(as_text=True)
        character_values_table = r"""
<table class="ntdata">
  <tbody>
        <tr>
