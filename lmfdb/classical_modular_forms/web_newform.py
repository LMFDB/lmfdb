  ...
  <a onclick="switch_basis('forward-basis'); return false" href='#'>Display \(\beta_i\) in terms of \(%s^j\)</a>
    ...
    def display_twists(self):
        ...
        twists1 = ['<table class="ntdata" style="float: left">', '<thead>',
                   '<tr><th colspan=8 align="center">By %s</th></tr><tr>'% display_knowl('cmf.twisting_character','twisting character orbit'), '<tr>',
                  th_wrap('character.dirichlet.galois_orbit_label', 'Char'),
                  th_wrap('character.dirichlet.parity', 'Parity'),
                  th_wrap('character.dirichlet.order', 'Ord'),
                  th_wrap('character.dirichlet.degree', 'Deg'),
        ...
        twists2 = ['<table class="ntdata">', '<tr><th colspan=8 align="center">By twisted newform orbit</th></tr><thead>',
                   '<tr><th colspan=8 align="center">By %s</th></tr>'% display_knowl('cmf.twisted_newform','twisted newform orbit'), '<tr>',
                  th_wrap('cmf.twist_newform', 'Twist'),
                  th_wrap('cmf.twist_dimension', 'Dim'),
                  th_wrap('character.dirichlet.galois_orbit_label', 'Char'),
                  th_wrap('character.dirichlet.parity', 'Parity'),
