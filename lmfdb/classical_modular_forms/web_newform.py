  ...
  <a onclick="switch_basis('forward-basis'); return false" href='#'>Display \(\beta_i\) in terms of \(%s^j\)</a>
    ...
    def display_twists(self):
        ...
        for r in self.twists:
            ...
            minimality = '&check;' if r['target_label'] == self.minimal_twist else '=' if r['target_is_minimal'] else '&tilde;' if r['target_label'].split('.')[0] == self.minimal_twist.split('.')[0] else ''
