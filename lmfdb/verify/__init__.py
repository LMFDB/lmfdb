...
# It is intended for use from an interactive sage prompt or from a Python
# script
...
if is_running():
    raise RuntimeError(
        "Cannot verify while running website (SQL injection vulnerabilities)")
...
for dirpath, dirs, filenames in os.walk(_curdir):
    ...
    # this filters out any table names that end up in log files
