...
class mf_hecke_lpolys(MfChecker):
    ...
    def check_total_count(self):
        ...
        return self.check_count(
            25 * db.mf_newforms.count({'field_poly': {'$exists': True}}))
    ...
    def check_prime_count(self):
        ...
        return accumulate_failures(self.check_count(
            cnt, {'p': p}) for p in prime_range(100))
