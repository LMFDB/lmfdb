...
class AVHomeTest(LmfdbTest):
    ...
    def test_stats_page(self):
        self.check_args("/Variety/Abelian/Fq/stats",
                        "Abelian variety isogeny classes: Statistics")
    ...
    def test_completeness_page(self):
        ...
        """
        page = self.tc.get(
            "/Variety/Abelian/Fq/Completeness").get_data(as_text=True)
    ...
    # Various searches
    # Many things are checked twice: Once from main index/browse page, and
    # once from the refining search page
    ...
    def test_count_table(self):
        ...
        self.check_args(
            "/Variety/Abelian/Fq/?search_type=Counts&simple=yes",
            "106706")
        self.check_args(
            "/Variety/Abelian/Fq/?search_type=Counts&q=32-100&g=2-4",
            "6409")
        self.check_args(
            "/Variety/Abelian/Fq/?search_type=Counts&q=4..7&g=2..4",
            "2953")
        self.check_args(
            "/Variety/Abelian/Fq/?search_type=Counts&q=2-27&g=1%2C3%2C5",
            "30543")
        # check that the links are functional
        self.check_args(
            "/Variety/Abelian/Fq/?search_type=Counts",
            "/Variety/Abelian/Fq/?g=5&amp;q=3")
        # and that it deals with invalid input
        self.check_args(
            "/Variety/Abelian/Fq/?search_type=Counts&q=2-27&g=x",
            "not a valid input")
    ...
    def test_geom_decomp_search(self):
        ...
        self.not_check_args(
            "/Variety/Abelian/Fq/?geom_squarefree=Yes",
            "2.2.ae_i")

        # search for squarefree and geometrically squarefree
        self.check_args(
            "/Variety/Abelian/Fq/?geom_squarefree=YesAndGeom",
            "1.2.ac")
        self.not_check_args(
            "/Variety/Abelian/Fq/?geom_squarefree=YesAndGeom",
            "2.2.ad_f")
        ...
        self.check_args(
            "/Variety/Abelian/Fq/?geom_squarefree=YesNotGeom",
            "2.2.ad_f")

        # search for non squarefree
        self.check_args("/Variety/Abelian/Fq/?geom_squarefree=No", "2.2.ae_i")
        self.check_args(
            "/Variety/Abelian/Fq/?geom_squarefree=No&g=1",
            "No matches")

        # search for not geometrically squarefree
        self.check_args(
            "/Variety/Abelian/Fq/?geom_squarefree=NotGeom",
            "2.2.ae_i")
    ...
    def test_primitive_search(self):
        ...
        """
        self.check_args(
            "/Variety/Abelian/Fq/?q=4&primitive=no&g=2",
            "2.4.ad_f")
        self.check_args(
            "/Variety/Abelian/Fq/?q=4&primitive=yes&g=2",
            "2.4.af_o")
        self.not_check_args(
            "/Variety/Abelian/Fq/?q=4&primitive=yes&g=2",
            "2.4.ad_f")
    ...
    def test_search_prank(self):
        ...
        self.not_check_args(
            "/Variety/Abelian/Fq/?q=9&g=2&p_rank=2",
            "2.9.b_ad")
    ...
    def test_search_newton(self):
        ...
        self.check_args(
            "/Variety/Abelian/Fq/?newton_polygon=%5B0%2C1%5D",
            "1.2.ab")
        ...
        self.check_args(
            "/Variety/Abelian/Fq/?newton_polygon=t",
    ...
    def test_search_pointcountsav(self):
        ...
        """
        self.check_args(
            "/Variety/Abelian/Fq/?abvar_point_count=%5B75%2C7125%5D",
            "2.9.ab_d")
        self.check_args(
            "/Variety/Abelian/Fq/?abvar_point_count=%5B75%2C7125%5D",
            "2.9.ab_d")
    ...
    def test_search_pointcountscurve(self):
        ...
        """
        self.check_args(
            "/Variety/Abelian/Fq/?curve_point_count=%5B9%2C87%5D",
            "3.9.ab_d_abs")
        self.check_args(
            "/Variety/Abelian/Fq/?curve_point_count=%5B9%2C87%5D",
            "3.9.ab_d_abs")
    ...
    def test_search_anglerank(self):
        ...
        """
        self.check_args(
            "/Variety/Abelian/Fq/?q=3&g=4&angle_rank=2",
            "4.3.ag_p_au_y")
        self.check_args(
            "/Variety/Abelian/Fq/?q=3&g=4&angle_rank=2",
            "4.3.ag_p_au_y")
    ...
    def test_search_isogfactor(self):
        ...
        self.check_args(
            "/Variety/Abelian/Fq/?dim1_factors=6&dim1_distinct=1",
            "5 matches")
    ...
    def test_search_numberfield(self):
        ...
        # 4.0.9726525.1
        self.check_args(
            "/Variety/Abelian/Fq/?number_field=4.0.9726525.1",
            "2.193.ax_tn")
        self.check_args(
            "/Variety/Abelian/Fq/?number_field=4.0.9726525.1",
            "2.193.ax_tn")
    ...
    def test_search_jacobian(self):
        ...
        # Jacobians only
        self.check_args(
            "/Variety/Abelian/Fq/?q=3&g=2&jacobian=yes",
            "2.3.ae_i")
        self.check_args(
            "/Variety/Abelian/Fq/?q=3&g=2&jacobian=yes",
            "2.3.ae_i")
        ...
        self.check_args("/Variety/Abelian/Fq/?q=3&g=2&jacobian=no", "2.3.a_af")
        self.not_check_args(
            "/Variety/Abelian/Fq/?q=3&g=2&jacobian=no",
            "2.3.ae_i")
        self.not_check_args(
            "/Variety/Abelian/Fq/?q=3&g=2&jacobian=no",
            "2.3.ae_i")
        # unknowns
        self.check_args(
            "/Variety/Abelian/Fq/?g=4&p_rank=4&jacobian=not_yes&polarizable=yes",
            "4.2.ag_t_abq_cr")
        self.check_args(
            "/Variety/Abelian/Fq/?q=2&g=3&p_rank=0&jacobian=not_no",
            "3.2.c_c_c")
    ...
    def test_search_princpol(self):
        ...
        self.check_args(
            "/Variety/Abelian/Fq/?q=5&g=2&polarizable=yes",
            "2.5.ab_f")
        self.check_args(
            "/Variety/Abelian/Fq/?q=5&g=2&polarizable=yes",
            "2.5.ab_f")
        ...
        self.check_args(
            "/Variety/Abelian/Fq/?q=5&g=2&polarizable=no",
            "2.5.ac_ab")
        self.check_args(
            "/Variety/Abelian/Fq/?q=5&g=2&polarizable=no",
            "2.5.ac_ab")
        ...
        self.check_args(
            ...
            "2.17.ae_ab")
        self.check_args(
            "/Variety/Abelian/Fq/?q=17&g=2&jacobian=no&polarizable=not_no",
            "2.17.aj_cc")
        self.check_args(
    ...
    def test_search_galois(self):
        ...
        self.check_args(
            "/Variety/Abelian/Fq/?q=9&galois_group=4T3",
            "2.9.af_u")
        self.check_args(
            "/Variety/Abelian/Fq/?galois_group=8T12",
            "4.2.b_b_e_f")
        self.check_args(
            "/Variety/Abelian/Fq/?p_rank=0&galois_group=C4",
            "2.64.i_cm")
    ...
    def test_search_combos(self):
        ...
        self.check_args(
            "/Variety/Abelian/Fq/?q=25&g=2&count=100",
            "2.25.an_do")
        ...
        self.check_args(
            "/Variety/Abelian/Fq/?g=3&jacobian=no&polarizable=not_no",
            "3.2.a_a_ae")
        self.check_args(
            "/Variety/Abelian/Fq/?g=3&jacobian=no&polarizable=yes",
            "3.2.a_ac_a")
