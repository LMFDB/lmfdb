...
from lmfdb.utils.search_parsing import BRACKETING_RE, QQ_RE, _multiset_encode, search_parser, nf_string_to_label, _parse_subset
...
def parse_nf_string(inp, query, qfield):
    ...
    _parse_subset(fields, query, qfield, mode='append', radical=None, product=None)
...
def parse_galgrp(inp, query, qfield):
    ...
    try:
        ...
        _parse_subset(groups, query, qfield, mode='append', radical=None, product=None)
    except NameError:
