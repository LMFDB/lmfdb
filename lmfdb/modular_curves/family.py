...
class XN(ModCurveFamily_base):
    ...
    sl2level = "N"
    index = "N+1"
    psl2index = r"i(\Gamma(N)) = \begin{cases} 6, & \text{ if } N = 2, \\ \frac{N^3}{2}\prod_{p|N, \text{ prime}} \big( 1 - p^{-2} \big), & \text{ if } N >2. \end{cases}"
    genus = "g"
    nu2 = r"$\nu_2(\Gamma(N)) = \begin{cases} 1, & \text{ if } N = 1, \\ 0, & \text{ if } N >1.\end{cases}$"
    nu3 = r"$\nu_3(\Gamma(N)) = \begin{cases} 1, & \text{ if } N = 1, \\ 0, & \text{ if } N >1.\end{cases}$"
    cusps = r"$\nu_\infty(\Gamma(N)) = \begin{cases} 1, & \text{ if } N = 1, \\ i(\Gamma(N))/2, & \text{ if } N > 1. \end{cases}$"
    rational_cusps = r"\nu_\infty(\Gamma(N)) = \begin{cases} 1, & \text{ if } N = 1, \\ i(\Gamma(N))/2, & \text{ if } N > 1. \end{cases}"
