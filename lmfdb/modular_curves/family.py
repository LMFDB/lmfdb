...
class X0N(ModCurveFamily_base):
    ...
    sl2level = "N"
    index = "N+1"
    psl2index = r"i = N\cdot \prod_{p|N, \text{ prime}} \left(1 + \frac{1}{p}\right)"
    genus = "g"
...
class XN(ModCurveFamily_base):
    ...
    sl2level = "N"
    index = "N+1"
    psl2index = r"i = \begin{cases} 6, & \text{ if } N = 2, \\ \frac{N^3}{2}\prod_{p|N, \text{ prime}} \left( 1 - \frac{1}{p^2} \right), & \text{ if } N >2. \end{cases}"
    genus = "g"
...
class Xarith1MMN(ModCurveFamily_base):
    ...
    sl2level = "N"
    index = "N"
    psl2index = r"i = \frac{M^3N^2}{2} \cdot \prod_{p|MN} \left(1 - \frac{1}{p^2}\right)"
    genus = "g"
    nu2 = r"$\nu_2 = 0$"
    nu3 = r"$\nu_3 = 0$"
    cusps = r"$\nu_\infty = \sum_{d \mid MN } \varphi (MN/d) \varphi(d) \gcd (M,MN/d)$"
...
class XspN(ModCurveFamily_base):
    ...
    genus = "g"
    nu2 = r"$\nu_2 = \begin{cases}0 & \text{if $2\mid N$,} \\ \prod_{p|N} \left( 1 + \left(\frac{-1}{p}\right) \right) & \text{otherwise.}\end{cases}$" 
    nu3 = r"$\nu_3 = \begin{cases}0 & \text{if $2\mid N$,} \\ \prod_{p|N} \left(1 + \left(\frac{-3}{p}\right) \right) & \text{otherwise.}\end{cases}$"
    cusps = r"$\nu_\infty = N\cdot \prod_{p|N, \text{ prime}} \left(1 + \frac{1}{p}\right)$"
    rational_cusps = "1"
...
class XspplusN(ModCurveFamily_base):
    ...
    genus = "g"
    nu2 = r"$\nu_2 = \begin{cases}0 & \text{if $2\mid N$, } \\ \frac{1}{2}\cdot \prod_{p|N} \left( 1 + \left(\frac{-1}{p}\right) \right) & \text{otherwise.}\end{cases} + \left(2^{-\delta} \frac{N}{2}\cdot \prod_{p\mid N, p \equiv 1 \bmod 4}\left( 1 - \frac{1}{p}\right) \cdot \prod_{p\mid N, p \equiv 3 \bmod 4}\left(1 + \frac{1}{p}\right)\right)$"
    nu3 = r"$\nu_3 = \begin{cases}0 & \text{if $2\mid N$,} \\ \frac{1}{2}\cdot \prod_{p|N} \left(1 + \left(\frac{-3}{p}\right) \right) & \text{otherwise.}\end{cases} $"
...
class XnsN(ModCurveFamily_base):
    ...
    genus = "g"
    nu2 = r"$\nu_2 = \prod_{p\mid N} \left( 1 - \left( \frac{-1}{p} \right) \right)$"
    nu3 = r"$\nu_3 = \prod_{p|N} \left( 1 - \left( \frac{-3}{p} \right) \right)$"
    cusps = r"$\nu_\infty = \varphi(N)$"
    rational_cusps = "1"    
...
class XnsplusN(ModCurveFamily_base):
    ...
    genus = "g"
    nu2 = r"$\nu_2 = \sum_{p\mid N} \frac{1- \left( \frac{-1}{p} \right)}{2} \ + \ \left(\frac{1}{2}N \cdot \prod_{p|N}\left(1 + \frac{1}{p}\right) -\#S\right)$"
    nu3 = r"$\nu_3 = \frac{1}{2}\cdot \prod_{p|N} \left( 1 - \left( \frac{-3}{p} \right) \right)$"
    cusps = r"$\nu_\infty = \varphi(N)/2$"
    rational_cusps = r"$\nu_\infty = 0$"
