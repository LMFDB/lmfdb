...
class XspplusN(ModCurveFamily_base):
    ...
    genus = "g"
    nu2 = r"$\nu_2 = \begin{cases}2^{\omega(N)-1} & \text{if } p \equiv 1 \bmod{4} \text{ for every } \ p \mid N, \\ 0 & \text{otherwise,} \end{cases} + 2^{-\delta-1} N\cdot \prod_{p\mid N, \ p \equiv 1 \bmod 4}\left( 1 - \frac{1}{p}\right) \cdot \prod_{p\mid N, \ p \equiv 3 \bmod 4}\left(1 + \frac{1}{p}\right)$"
