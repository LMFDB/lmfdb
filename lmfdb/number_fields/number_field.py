...
class NF_download(Downloader):
    table = db.nf_fields
    title = "Number fields"
    data_description = "defining the number field generated by a root of the polynomial."
    function_body = {
        "magma": ["TODO : write function body code for magma" ],
