...
class HigherGenusWithAutomorphismsTest(LmfdbTest):
    ...
    def test_passport_label(self):
        ...
        assert '(1,8) (2,9) (3,10) (4,11) (5,12) (6,13) (7,14)' in L.get_data(
            as_text=True)
    ...
    def test_unique_groups_pages(self):
        ...
        assert 'Distribution of groups in curves of genus 5' in L.get_data(
            as_text=True)
    ...
    def underlying_data(self):
        page = self.tc.get(
            '/HigherGenus/C/Aut/3.8-3.0.2-2-4-4.1').get_data(as_text=True)
        assert 'Underlying data' in page and 'api/hgcwa_passports/?passport_label=3.8-3.0.2-2-4-4.1' in page
        page = self.tc.get(
            '/HigherGenus/C/Aut/3.8-3.0.2-2-4-4').get_data(as_text=True)
