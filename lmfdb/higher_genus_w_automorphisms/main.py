...
def render_family(args):
    ...
    if 'label' in args:
        ...
        downloads = [('Download code to Magma', url_for(".hgcwa_code_download",  label=label, download_type='magma')),
                     ('Download code to Gap', url_for(".hgcwa_code_download", label=label, download_type='gap'))]
