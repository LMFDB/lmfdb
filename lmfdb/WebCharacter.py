...
from sage.all import gcd, Rational, power_mod, Mod, Integer, Integers
import re
...
class ConreyCharacter:
    ...
    def __init__(self, modulus, number):
        ...
        print self.modulus, self.number
...
class WebSmallDirichletCharacter(WebChar, WebDirichlet):
    ...
    @property
    def conductor(self):
        print 'need conductor, computed %s'
        print 'found %s'%self.chi.conductor()
