...
def index():
    ...
    return render_template("motive-index.html", title="Motives",
                           bread=bread, credit=HGM_credit, info=info, friends=friends)
...
def index2():
    ...
    # return render_template("hypergeometric-index.html",
    # title="Hypergeometric motives", bread=bread, credit=HGM_credit,
