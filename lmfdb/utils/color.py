...
class ColorScheme():
    colors = {
        ...
        # Sidebar text in body and header, under Dat, gets over-written for the
        # rest.
        'col_sidebar_text': 'col_main',
        ...
        # a colors
        # This occurs in for some hyperlinks, and sidebar header text.
        'a_text': 'col_body_text',
        'a_inactive': c.black,
        # This occurs for the rest of the hyperlinks, and sidebar header text,
        # i.e., once visited
        'a_text_visited': 'col_visited',
        ...
        # This was specified twice in color.css; could also be col_main_ll
    ...
    def __allsubclasses__(cls):
        # Recursive version of __subclasses__ where subclasses are marked as
        # leaves if they have a code attribute
