...
class UtilsTest(unittest.TestCase):
    ...
    def test_complete(self):
        ...
        for tup in [
                ...
                ("nf_fields", {'degree': 2, 'r2': 0, 'regulator': {'$gte': 0, '$lte': 10}}, "number fields with degree 2"),
                ("nf_fields", {'degree': 3, 'r2': 0, 'regulator': {'$gte': 0, '$lte': 10}}, "number fields with degree 3"),
                ("nf_fields", {'degree': 4, 'r2': 0, 'regulator': {'$gte': 0, '$lte': 10}}, "number fields with degree 4"),
                ...
                ("ec_curvedata", {'bad_primes': {'$containedin': [2, 3, 5, 7]}}, "elliptic curves which are 7-smooth"),
                ("ec_curvedata", {'bad_primes': {'$containedin': [2, 3, 5, 7]}}, "elliptic curves which are 7-smooth"),
                ("g2c_curves", {'cond': {'$gte': 1, '$lte': 120}}, "genus 2 curves with conductor at most 120"),
