...
class UtilsTest(unittest.TestCase):
    ...
    def test_complete(self):
        ...
        for tup in [
                ...
                ("nf_fields", {'regulator': {'$gte': 0, '$lte': 0.24}}, "number fields with regulator at most 0.25"),
                ...
                ("nf_fields", {'degree': 2, 'r2': 0, 'regulator': {'$gte': 0, '$lte': 7}}, "number fields with degree 2, signature [2,0], regulator at most 7.2543"),
                ("nf_fields", {'degree': 3, 'r2': 0, 'regulator': {'$gte': 0, '$lte': 10}}, "number fields with degree 3, signature [3,0], regulator at most 7.2543"),
                ("nf_fields", {'degree': 4, 'r2': 0, 'regulator': {'$gte': 0, '$lte': 15}}, "number fields with degree 4, signature [4,0], regulator at most 7.2543"),
