...
class LfunctionTest(LmfdbTest):
    ...
    def test_LDirichlet(self):
        ...
        L = self.tc.get(
            '/L/Character/Dirichlet/6400/3/',
            follow_redirects=True)
        assert '2.131285033' in L.get_data(
            as_text=True) in L.get_data(
            as_text=True)
        #assert 'SatoTate' in L.get_data(as_text=True)
    ...
    def test_Lec(self):
        ...
        L = self.tc.get(
            '/L/EllipticCurve/2.2.5.1/31.1/a/',
            follow_redirects=True)
        ...
        assert 'Hilbert modular form 2.2.5.1-31.1-a' in L.get_data(
            as_text=True)
        assert 'Hilbert modular form 2.2.5.1-31.2-a' in L.get_data(
            as_text=True)
        #assert '/SatoTateGroup/1.2.' in L.get_data(as_text=True)
        assert '4-775-1.1-c1e2-0-0' in L.get_data(as_text=True)

        L = self.tc.get(
            '/L/EllipticCurve/2.2.5.1/80.1/a/',
            follow_redirects=True)
        ...
        assert 'Hilbert modular form 2.2.5.1-80.1-a' in L.get_data(
            as_text=True)
        #assert '/SatoTateGroup/1.2.' in L.get_data(as_text=True)
        assert '4-2000-1.1-c1e2-0-0' in L.get_data(as_text=True)

        L = self.tc.get(
            '/L/EllipticCurve/2.0.11.1/256.1/a/',
            follow_redirects=True)
        ...
        assert 'Hilbert modular form 2.2.44.1-16.1-a' in L.get_data(
            as_text=True)
        assert 'Hilbert modular form 2.2.44.1-16.1-c' in L.get_data(
            as_text=True)
        assert 'Bianchi modular form 2.0.11.1-256.1-a' in L.get_data(
            as_text=True)
        assert 'Bianchi modular form 2.0.11.1-256.1-b' in L.get_data(
            as_text=True)
        #assert '/SatoTateGroup/1.2.' in L.get_data(as_text=True)
        assert '4-176e2-1.1-c1e2-0-4' in L.get_data(as_text=True)

        L = self.tc.get(
            '/L/EllipticCurve/2.0.1879.1/1.1/a/',
            follow_redirects=True)
        #assert '/SatoTateGroup/1.2.' in L.get_data(as_text=True)
        ...
        L = self.tc.get(
            '/L/EllipticCurve/2.0.4.1/100.2/a/',
            follow_redirects=True)
        #assert '/SatoTateGroup/1.2.' in L.get_data(as_text=True)
        assert '0.5352579714' in L.get_data(as_text=True)
        assert 'Bianchi modular form 2.0.4.1-100.2-a' in L.get_data(
            as_text=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/20/2/a/a/',
            follow_redirects=True)
        assert '4.78130792717525308450176413839' in L.get_data(as_text=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/80/2/a/b/',
            follow_redirects=True)
        assert '2.76929890617261215013507568311' in L.get_data(as_text=True)
        ...
        L = self.tc.get(
            '/L/EllipticCurve/2.0.3.1/75.1/a/',
            follow_redirects=True)
        assert 'Bianchi modular form 2.0.3.1-75.1-a' in L.get_data(
            as_text=True)
        ...
        L = self.tc.get(
            '/L/EllipticCurve/2.0.8.1/2592.3/c/',
            follow_redirects=True)
        assert 'Bianchi modular form 2.0.8.1-2592.3-c' in L.get_data(
            as_text=True)
        assert 'Hilbert modular form 2.2.8.1-2592.1-f' in L.get_data(
            as_text=True)
        ...
        for url in ['EllipticCurve/2.0.11.1/11.1/a/',
                    'ModularForm/GL2/ImaginaryQuadratic/2.0.11.1/11.1/a/']:
    ...
    def test_Lcmf(self):
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/13/12/a/a/1/1/',
            follow_redirects=True)
        assert '4.84e4' in L.get_data(as_text=True)  # a_7
        assert '71.7' in L.get_data(as_text=True)  # a_2
        assert '1.51472556377341264746894823521' in L.get_data(
            as_text=True)  # first zero

        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/13/12/a/a/',
            follow_redirects=True)
        assert '1.51472556377341264746894823521' in L.get_data(
            as_text=True)  # first zero
        assert 'Origins of factors' in L.get_data(as_text=True)
        for i in range(1, 6):
            assert 'Modular form 13.12.a.a.1.%d' % i in L.get_data(
                as_text=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/1/18/a/a/',
            follow_redirects=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/13/4/c/a/3/1/',
            follow_redirects=True)
        assert '0.523757' in L.get_data(
            as_text=True) and '0.530517' in L.get_data(
            as_text=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/13/2/e/a/',
            follow_redirects=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/18/2/c/a/',
            follow_redirects=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/490/2/a/a/',
            follow_redirects=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/350/2/e/k/51/1/',
            follow_redirects=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/350/2/e/k/151/1/',
            follow_redirects=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/350/2/e/k/',
            follow_redirects=True)
        assert 'Modular form 350.2.e.k.151.1' in L.get_data(as_text=True)
        assert 'Modular form 350.2.e.k.51.1' in L.get_data(as_text=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/129/2/a/d/',
            follow_redirects=True)
        assert 'Modular form 129.2.a.d' in L.get_data(as_text=True)
        for i in range(1, 4):
            assert 'Modular form 129.2.a.d.1.%d' % i in L.get_data(
                as_text=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/60/2/i/a/',
            follow_redirects=True)
        assert 'Modular form 60.2.i.a' in L.get_data(as_text=True)
        for c in [17, 53]:
            for i in range(1, 3):
                assert 'Modular form 60.2.i.a.%d.%d' % (c, i) in L.get_data(
                    as_text=True), 'Modular form 60.2.%d.a.%d' % (c, i)
        assert '0.676894' in L.get_data(as_text=True)
        assert '2.15777231959226116393597609132' in L.get_data(as_text=True)
        assert '1 - 2 T + 2 T^{2} - 2 p T^{3} + p^{2} T^{4}' in L.get_data(
            as_text=True)
        assert r'(8,\ 12960000,\ (\ :1/2, 1/2, 1/2, 1/2),\ 1)' in L.get_data(as_text=True)

        L = self.tc.get(
            '/L/ModularForm/GL2/Q/holomorphic/207/2/i/b/',
            follow_redirects=True)
        for c in [55, 64, 73, 82, 100, 118, 127, 154, 163, 190]:
            assert 'Modular form 207.2.i.b.%d.1' % c in L.get_data(
                as_text=True), 'Modular form 207.2.%d.d.1' % c
        assert '0.233961' in L.get_data(as_text=True)
        assert '0.096070203083029088532433951629' in L.get_data(as_text=True)
        assert 'T + T^{2} + 21 T^{3} - 219 T^{4} - 1365 T^{5} - 219 p T^{6} + 21 p^{2} T^{7} + p^{3} T^{8}' in L.get_data(
            as_text=True)
        assert 'Plot not available' in L.get_data(as_text=True)

    def test_Lhmf(self):
        L = self.tc.get(
            '/L/ModularForm/GL2/TotallyReal/2.2.5.1/holomorphic/2.2.5.1-31.1-a/0/0/',
            follow_redirects=True)
        assert '0.3599289594' in L.get_data(as_text=True)
        assert '4-775-1.1-c1e2-0-0' in L.get_data(as_text=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/TotallyReal/2.2.8.1/holomorphic/2.2.8.1-9.1-a/0/0/',
            follow_redirects=True)
        ...
        L = self.tc.get(
            '/L/ModularForm/GL2/TotallyReal/2.2.24.1/holomorphic/2.2.24.1-1.1-a/0/0/',
            follow_redirects=True)
    ...
    def test_Lgl4maass(self):
        L = self.tc.get(
            ...
            follow_redirects=True)
        assert '4-1-1.1-r0e4-p2.27m6.04m13.14p16.90-0' in L.get_data(
            as_text=True)
    ...
    def test_Lartin(self):
        L = self.tc.get(
            '/L/ArtinRepresentation/2.23.3t2.1c1/',
            follow_redirects=True)
        assert '0.1740363269' in L.get_data(as_text=True)
        # same in new labels
        L = self.tc.get(
            '/L/ArtinRepresentation/2.23.3t2.b.a/',
            follow_redirects=True)
        assert '0.1740363269' in L.get_data(as_text=True)
    ...
    def test_Lgenus2(self):
        ...
        assert 'Bianchi modular form 2.0.8.1-324.3-a' in L.get_data(
            as_text=True)
        assert 'Hilbert modular form 2.2.24.1-36.1-a' in L.get_data(
            as_text=True)
    ...
    def test_Llhash(self):
        ...
        assert '324016' in L.get_data(
            as_text=True), "Missing data in /L/lhash/1938322253992393114/"
        ...
        L = self.tc.get(
            '/L/lhash/dirichlet_L_6253.458/',
            follow_redirects=True)
        assert '1.0612' in L.get_data(
            as_text=True), "Missing data in /L/lhash/dirichlet_L_6253.458/"
        assert '1-6253-6253.458-r1-0-0' in L.get_data(as_text=True)
        assert 'Dual L-function' in L.get_data(as_text=True)
        assert 'Character/Dirichlet/6253/458' in L.get_data(as_text=True)

        L = self.tc.get(
            '/L/Lhash/7200459463482029776252499748763/',
            follow_redirects=True)
        assert 'Dual L-function' in L.get_data(as_text=True)
        assert 'Modular form 13.4.c.a.3.1' in L.get_data(as_text=True)
        assert 'ModularForm/GL2/Q/holomorphic/13/4/c/a/3/1' in L.get_data(
            as_text=True)

    def test_tracehash(self):
        L = self.tc.get(
            '/L/tracehash/7200459463482029776252499748763/',
            follow_redirects=True)
        assert 'trace_hash = 7200459463482029776252499748763 not in [0, 2^61]' in L.get_data(
            as_text=True)
        L = self.tc.get(
            '/L/tracehash/1938322253992393114/',
            follow_redirects=True)
        assert '324016' in L.get_data(
            as_text=True), "Missing data in /L/tracehash/1938322253992393114/"
        assert 'Dual L-function' not in L.get_data(as_text=True)
        assert '2-324016-1.1-c1-0-6' in L.get_data(as_text=True)
        assert 'Elliptic curve 324016.h' in L.get_data(as_text=True)

        L = self.tc.get(
            '/L/tracehash/1127515239490717889/',
            follow_redirects=True)
    ...
    def test_jump(self):
        self.check_args(
            '/L/?jump=4-167040-1.1-c1e2-0-7',
            'Functional equation')
        self.check_args(
            '/L/?jump=3-1-1.1-r0e3-m9.92m29.99p39.92-0',
            'Functional equation')
        self.check_args(
            '/L/?jump=2-1.2.1-r0e2-0-4',
            'Malformed L-function label')
    ...
    def test_errorMessages(self):
        ...
        assert 'The requested URL was not found on the server' in L.get_data(
            as_text=True)

        L = self.tc.get('/L/Character/Dirichlet/9/10/')
        assert 'L-function for dirichlet character with label 9.10 not found' in L.get_data(
            as_text=True)

        L = self.tc.get('/L/EllipticCurve/Q/11/b/')
        assert 'L-function for elliptic curve isogeny class with label 11.b not found' in L.get_data(
            as_text=True)

        L = self.tc.get('/L/ModularForm/GL2/Q/holomorphic/5/6/d/c/')
        assert 'L-function for classical modular form with label 5.6.d.c not found' in L.get_data(
            as_text=True)

        L = self.tc.get(
            '/L/ModularForm/GL3/Q/Maass/1/1/16.40312_0.171121/-0.421999/')
        assert 'L-function for modular form ModularForm/GL3/Q/Maass/1/1/16.40312_0.171121/-0.421999/ not found' in L.get_data(
            as_text=True)

        L = self.tc.get(
            '/L/ModularForm/GL2/TotallyReal/2.2.5.1/holomorphic/2.2.5.1-31.1-a/2/0/')
        assert 'not in the database' in L.get_data(as_text=True)

        L = self.tc.get(
            '/L/ModularForm/GL2/TotallyReal/2.2.5.1/holomorphic/2.2.5.1-31.5-a/0/0/')
        assert 'not in the database' in L.get_data(as_text=True)

        L = self.tc.get('/L/Genus2Curve/Q/247/a/')
        assert 'L-function for genus 2 curve with label 247.a not found' in L.get_data(
            as_text=True)
    ...
    def test_underlying_data(self):
        data = self.tc.get(
            "/L/data/2-289379-1.1-c1-0-0").get_data(as_text=True)
