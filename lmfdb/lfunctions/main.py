...
def l_function_cmf_old(level, weight, character, hecke_orbit, number):
    ...
    return flask.redirect(url_for('.l_function_cmf_page', level=level, weight=weight, char_orbit_label=char_orbit_label, hecke_orbit=hecke_orbit, character=character, number=number), code=301)
