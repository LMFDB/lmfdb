...
from lmfdb.utils import (
    ...
    StatsDisplay, parse_element_of, parse_signed_ints, search_wrap, redirect_no_cache, integer_squarefree_part)
...
ec_columns = SearchColumns([
     ...
     SearchCol("class_size", "ec.isogeny_class", "Class size", align="center", default=lambda info: info.get("class_size") or info.get("optimal") == "on"),
     SearchCol("class_deg", "ec.isogeny_class_degree", "Class degree", align="center", default=lambda info: info.get("class_deg")),
     ProcessedCol("conductor", "ec.q.conductor", "Conductor", lambda v: web_latex(factor(v)), default=True, align="center"),
     ProcessedCol("equation", "ec.q.minimal_weierstrass_equation", "Weierstrass equation", lambda ainvs: latex_equation(ainvs),
                  default=True, align="left", orig="ainvs"),
