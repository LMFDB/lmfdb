...
class ECisog_class(object):
    ...
    def make_class(self):
        ...
        self.downloads = [('Download q-expansion to text', url_for(".download_EC_qexp", label=self.lmfdb_iso, limit=1000)),
                         ('Download all stored data to text', url_for(".download_EC_all", label=self.lmfdb_iso))]
