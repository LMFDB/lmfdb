...
class EcnfIsogClassTest(LmfdbTest):
    ...
    def test_ecnf_isgclass_title(self):
        ...
        """
        L = self.tc.get(
            '/EllipticCurve/2.0.7.1/16.1/CMa/').get_data(as_text=True)
    ...
    def test_ecnf_label_in_isgclass(self):
        ...
        """
        L = self.tc.get(
            '/EllipticCurve/2.0.3.1/2268.1/a/').get_data(as_text=True)
    ...
    def test_ecnf_weiercoeffs_in_isgclass(self):
        ...
        """
        L = self.tc.get(
            '/EllipticCurve/2.2.497.1/4.1/c/').get_data(as_text=True)
    ...
    def test_ecnf_isgmatrix_in_ecnf_isgclass(self):
        ...
        """
        L = self.tc.get(
            '/EllipticCurve/2.2.89.1/81.1/a/').get_data(as_text=True)
        assert '267' in L
        assert '89' in L
    ...
    def test_ecnf_isclass_related_object(self):
        ...
        """
        L = self.tc.get(
            '/EllipticCurve/2.2.5.1/31.1/a/').get_data(as_text=True)
        ...
        L = self.tc.get(
            '/EllipticCurve/2.0.11.1/256.1/b/').get_data(as_text=True)
